...
Usage:
    python evaluate_model.py --model checkpoints_regi/regi_masked_ppo_final --n-battles 100
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        # default="outputs/checkpoints_regi_v2/train2_final_model.zip",
        default="outputs/checkpoints_regi_v2/train2_model_50000_steps.zip",
